...
func (r *RemoteRPCClient) ConvertPDEPrices(FromTokenIDStr string, ToTokenIDStr string, amount float64) (res []rpcserver.ConvertedPrice, err error) {
	requestBody, err := json.Marshal(map[string]interface{}{
		"jsonrpc": "1.0",
		"method":  "convertpdeprices",
		"params":  []interface{}{FromTokenIDStr, ToTokenIDStr, amount},
		"id":      1,
	})
	if err != nil {
		return res, err
	...
	resp := struct {
		Result []rpcserver.ConvertedPrice
		Error  *ErrMsg
	}{}
	err = json.Unmarshal(body, &resp)
